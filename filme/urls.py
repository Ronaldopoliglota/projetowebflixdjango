# Sempre que for construir uma página deverá ser criada três coisa
# link das urls, as views e os templates

from django.urls import path, reverse_lazy
from .views import Homepage, Homefilmes, Detalhefilme, PesquisarFime, PaginaPerfil, CriarConta
...
urlpatterns = [
    ...
    path('pesquisa/', PesquisarFime.as_view(), name='pesquisar'),
